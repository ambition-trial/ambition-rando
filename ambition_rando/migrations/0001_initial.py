# Generated by Django 2.0 on 2017-12-28 13:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified_datetime', models.DateTimeField(null=True)),
                ('verified_user', models.CharField(max_length=50, null=True)),
                ('allocated_site', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='sites.Site')),
            ],
            options={
            ...
            managers=[
                ...
                ('on_site', django.contrib.sites.managers.CurrentSiteManager('allocated_site')),
            ],
        ),
