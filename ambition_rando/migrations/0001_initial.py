    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allocation', django_crypto_fields.fields.encrypted_text_field.EncryptedTextField(blank=True, help_text=' (Encryption: AES local)', max_length=71, null=True, verbose_name='Original integer allocation')),
